...
const HowItWorks = () => {
    const cardData = [
        ...
        { id: 2, heading: "Share Event Details", comment: "Provide event name, date, time, image, contact number, and your temporary lipa number.", icon: <GrDocumentText className='icon icon-active' />, color: "lab(9 -0.81 -5.67)" },
        { id: 3, heading: "We Set Everything Up", comment: "Y-Ya creates your event page, QR code, and the features included in your package.", icon: <IoSettingsOutline className='icon' />, color: "lab(9 -0.81 -5.67)" },
        { id: 4, heading: "Guests Scan & Celebrate", comment: "Guests scan the QR code to send gifts, upload moments, and join the live celebration.", icon: <LuScanLine className='icon' />, color: "lab(9 -0.81 -5.67)" }
    ]
    return (
